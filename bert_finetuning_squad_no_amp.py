...
def fsdp_main(local_rank, world_size, args):
    ...
    if args.do_train:
        ...
        pickle_path = 'workspace/bert/data/v1.1/squad.pkl'
        check_file = os.path.isfile(pickle_path)
        if check_file:
            with open('workspace/bert/data/v1.1/squad.pkl', 'rb') as f:
                train_examples = pickle.load(f)
        else:
            train_examples = read_squad_examples(
                input_file=args.train_file, is_training=True, version_2_with_negative=args.version_2_with_negative)
            with open('workspace/bert/data/v1.1/squad.pkl', 'wb') as f:
